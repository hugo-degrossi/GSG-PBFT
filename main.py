...
nodes[0]=[("faulty_primary",0),("non_responding_node",0),("slow_nodes",0),("faulty_node",0),("faulty_replies_node",0),("moving_node",4),("honest_node",30)] # Nodes starting from the beginning
...
# Run clients:
requests_number = 60  # The user chooses the number of requests he wants to execute simultaneously (They are all sent to the PBFT network at the same time) - Here each request will be sent by a different client
clients_list = []
