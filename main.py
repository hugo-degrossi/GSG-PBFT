...
nodes[0]=[("faulty_primary",0),("non_responding_node",0),("slow_nodes",0),("faulty_node",0),("faulty_replies_node",0),("moving_node",4),("honest_node",20)] # Nodes starting from the beginning
